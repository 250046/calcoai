TRANSLATIONS = {
    ...
    "en": {
        ...
        "manage_loans": "💰 Loans",
        "settings": "⚙️ Settings",
        "send_transaction": "💬 Write your expense or income.\n\nFor example:\n• \"Spent 15000 on groceries\"\n• \"Received salary 500000\"\n• \"Today 25000 for transport\"",
        "transaction_added": "✅ Added!\n\n💰 Amount: {amount} sum\n📁 Category: {category}\n📝 Description: {description}\n📅 Date: {date}",
        "transaction_error": "❌ An error occurred. Please try again.",
        "parse_error": "❌ Couldn't understand. Please be more specific.\n\nFor example: \"10000 for bread\"",
        "history_empty": "📭 Nothing here yet",
        "history_title": "📜 Last 10 transactions:",
        "monthly_report_text": "📊 Report for {month} month\n\n💰 Income: {income} sum\n💸 Expense: {expense} sum\n📈 Balance: {balance} sum\n\n📝 Total transactions: {count}",
        "loan_menu": "💰 Loans\n\nWhat would you like to do?",
        "add_loan": "➕ Lend Money",
        "view_loans": "📋 Loans List",
        "back": "🔙 Back",
        "loans_empty": "📭 No loans",
        "loans_list": "📋 Loans list:\n\n",
        "loan_item": "👤 {person}\n💰 {amount} sum\n📅 {date}\n📌 Status: {status}\n\n",
        "send_loan_info": "💬 Write loan information.\n\nFor example: \"Lent Ali 100000\"",
